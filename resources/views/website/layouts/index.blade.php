...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{url('/dashboard_assets')}}/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css"/>
    ...
    <link rel="stylesheet" type="text/css"
          href="{{url('/dashboard_assets')}}/global/plugins/bootstrap-toastr/toastr.min.css"/>

    <link rel="stylesheet" href="{{url('website/')}}/assets/select2/select2.min.css?v5">
    @if(app()->getLocale() == 'ar')
        <link rel="stylesheet" href="{{url('website/')}}/assets/css/style-rtl.css?v5">

    @else

        <link rel="stylesheet" href="{{url('website/')}}/assets/css/style-ltr.css?v5">
    @endif
    <link rel="stylesheet" href="{{url('website/')}}/assets/css/style.css?v5">
                        ...
                        <form role="form" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-md-12 m-t-10 sm-m-t-10">
                                    ...
                                    <button type="reset" class="btn btn-dark  m-t-5" class="close" data-dismiss="modal"
                                            aria-hidden="true">@lang('admin.cancel')</button>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <form role="form" action="{{route('edit_profile')}}" autocomplete="off"
                            ...
                            <div class="form-group-attached">
                                ...
                                <div class="row">
                                    <div class="col-md-12 m-t-10 sm-m-t-10">
                                        <button type="submit"
                                                class="btn btn-primary  m-t-5">@lang('admin.save')</button>
                                        <button type="reset" class="btn btn-danger  m-t-5" class="close"
                                                data-dismiss="modal" aria-hidden="true">@lang('admin.cancel')</button>
                                    </div>
                                </div>
                            </div>
                        </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content form_login_content">
                <div class="modal-header text-center">
                    <h4 class="modal-title w-100 font-weight-bold">@lang('admin.Sign in')</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{route('website.login')}}" method="post" class="form_login">
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form  mb-4">
                            <p>@lang('admin.I don\'t have account') <a href="#"
                                                                       class="show_register_form">@lang('admin.Sign up')</a>
                            </p>
            ...
            <div class="modal-content form_register_content" style="display: none">
                ...
                <form action="{{route('website.register')}}" method="post" class="form_register">
                    <div class="modal-body mx-3">
                        ...
                        <div class="md-form  mb-4">
                            <p>@lang('admin.I have account') <a href="#"
                                                                class="show_login_form">@lang('admin.Sign in')</a></p>
...
<script type="text/javascript"
        src="{{url('/dashboard_assets')}}/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js"></script>
...
<script src="{{url('website/')}}/assets/select2/select2.min.js"></script>
<script src="{{url('website/')}}/assets/js/main.js?v=1"></script>
