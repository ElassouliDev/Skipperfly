    ...
    <div class="col-md-12 col-sm-12">
        <div class="portlet light">
            ...
            <div class="portlet-body form">
                <div class="row">
                    <div class="col-md-12">
                        <form role="form" method="post" action="{{route('dashboard.admin.update',$admin->id)}}"
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <input type="about" class="form-control" name="about"
                                                   value="{{old('about')?:$admin->about}}" required
