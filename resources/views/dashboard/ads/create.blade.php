                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <input type="text" class="form-control" id="form_control_1" name="desc_ar"
                                                   value="{{old('desc_ar')}}" placeholder="@lang('admin.desc_ar')">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input">
                                            <input type="url" class="form-control" id="form_control_1" name="link"
                                                   value="{{old('link')}}" placeholder="@lang('admin.url')">
                                        ...
                                        <div class="form-group form-md-line-input">
                                            ...
                                            <select name="ads_type" required class="form-control">
                                                @foreach(\App\Models\Ads::ads_type as $type)
                                                    <option value="{{$type}}">@lang("admin.type_$type")</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-md-line-input company_id " style="display: none">
